  ...
  <section class="hero" id="hero">
    ...
    <div class="wrap hero__in">
      <div class="hero__top">
        ...
        <h1 class="h1 hero__h1" data-hero-h>Structural Steel Engineering and Metal Craft Works.</h1>
    ...
    <div class="wrap">
      <div class="shead">
        ...
        <div class="shead__grid">
          <h2 class="h2 shead__title" data-split>Proven expertise. Proven delivery.</h2>
        </div>
      </div>
  ...
  <section class="sec sec--paper" id="services">
    <div class="wrap">
      <div class="shead">
        ...
        <div class="shead__grid">
          <h2 class="h2 shead__title" data-split>Five specialties, one seamless experience.</h2>
  ...
  <section class="sec sec--white" id="products">
    <div class="wrap">
      <div class="shead">
        ...
        <div class="shead__grid">
          <h2 class="h2 shead__title" data-split>Structural Steel Engineering and Metal Craft Works.</h2>
...
<main id="main">
  ...
  <section class="phero">
    <div class="phero__bg" aria-hidden="true">
      <picture><source srcset="assets/img/prd-decorative-wall-design-800.webp 800w, assets/img/prd-decorative-wall-design-1400.webp 1400w" type="image/webp"><source srcset="assets/img/prd-decorative-wall-design-800.jpg 800w, assets/img/prd-decorative-wall-design-1400.jpg 1400w" type="image/jpeg"><img src="assets/img/prd-decorative-wall-design-1400.jpg" alt="" width="1400" height="1400" fetchpriority="high" decoding="async" data-parallax="-8"></picture>
    </div>
    <div class="wrap phero__in">
      <nav class="crumbs" aria-label="Breadcrumb">
      ...
      <h1 class="h1 phero__h" data-hero-h>Completed work, every category.</h1>
      <p class="lead lead--i phero__d" data-hero-sub>UPVC, drainage, access hatches and covers, customised kitchens, handrails and balustrades, decorative metalwork and tailor-made fabrication, drawn from finished projects across the UAE.</p>
      <div class="hero__acts" data-hero-act>
  ...
  <section class="sec sec--white">
    <div class="wrap">
      <div class="dim" style="margin-bottom:1.6rem">
        <span class="dim__txt">Gallery</span><span class="dim__line"></span><span class="dim__txt">{len(GALLERY)} photographs</span>
      </div>
      <div class="gal gal--wall" data-stagger>{gal}</div>
    </div>
  </section>
